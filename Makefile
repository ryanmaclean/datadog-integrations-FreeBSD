...
OPTIONS_DEFINE=	APACHE BIND9 CONSUL COREDNS DIRECTORY DISK DNS HAPROXY MYSQL NETWORK NGINX PHP POSTFIX POSTGRES PROCESS REDIS SMART SNMP SSH SYS_CORE SYS_SWAP TCP TLS UNBOUND ZFS

OPTIONS_SUB=	yes

APACHE_DESC=	Apache check integration
BIND9_DESC=	BIND9 check integration
